...
<ul>
<li>поле&nbsp;<strong><em>Номер карты</em></strong>: 4444 4444 4444 4442 (DECLINED карта); рандомный номер, отличный от тестовых (1111 6666 2222 8888); пустое поле; нули (0000 0000 0000 0000); 1 цифра; 15 цифр; 17 цифр;</li>
...
<ol>
<li><strong> Перечень и описание возможных рисков при автоматизации</strong></li>
</ol>
<ul>
...
<ol>
<li><strong> Интервальная оценка с учётом рисков в часах</strong></li>
</ol>
<ul>
...
<ol>
<li><strong> План сдачи работ: когда будут проведены автотесты, результаты их проведения и отчёт по автоматизации</strong></li>
</ol>
<ul>
